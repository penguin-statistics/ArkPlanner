...
[Web前端](https://www.genesis.moe/arknights/)由@invisiblearts完成。
...
ArkPlanner is a tiny python tool for the mobile game Arknight. It helps you make the smartest strategies for any given combinations of the required item based on open-sourced stats data, items synthesize rules. It considers both items dropping rate and synthesize rules as coefficients of restrictions and minimize the total cost using Linear Programming.
