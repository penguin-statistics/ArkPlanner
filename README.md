...
[Web Demo](https://planner.penguin-stats.io/) at Penguin-Stat is available now. Demo is based on the [Front-end](https://ak.inva.land/) version implemented by [@invisiblearts](https://github.com/invisiblearts).
